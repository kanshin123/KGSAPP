 ...
 */
public class BoardContentFragment2 extends Fragment {
    ...
    public void getListData(String sListName, final String sLastNo) {
        ...
        aq.ajax("http://kgs.yunstone.com/ajax/board.php?lat=" +lat+"&lon="+lon+"&start=0&uuid="+uuid+"&set=2", JSONObject.class, new AjaxCallback<JSONObject>() {
            @Override
                                ...
                                */
                                ...
                                alertdialog.setPositiveButton(getString(R.string.toast4), new DialogInterface.OnClickListener(){
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        //aq.ajax(AppVar.API_ROOT + sListName + ".php?key=" + AppVar.API_KEY + "&last=" + sLastNo, JSONObject.class, new AjaxCallback<JSONObject>() {
                                        aq.ajax("http://kgs.yunstone.com/ajax/policesend.php?muid=" +muid+"&fuid="+fuid+"&section=2&uuid="+uuid+"&message="+message, JSONObject.class, new AjaxCallback<JSONObject>() {
                                            @Override
                                            public void callback(String url, JSONObject object, AjaxStatus status) {
                                                if (object != null) {
                                                    //로딩표시 지움.
                                ...
                                alert.setIcon(R.drawable.ic_add_alert);
                                // 타이틀
                                alert.setTitle(R.string.toast26);
                                // 다이얼로그 보기
                                alert.show();
