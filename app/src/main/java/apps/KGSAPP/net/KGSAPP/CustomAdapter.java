...
/**
 * Created by 2nd_user on 2015-09-06.
 */
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if( m_List.get(position).type == 0 ) {
            //text.setBackgroundResource(R.drawable.message_in);
            text.setBackgroundResource(R.drawable.inbox);
            layout.setGravity(Gravity.LEFT);
            viewRight.setVisibility(View.GONE);
            viewLeft.setVisibility(View.GONE);
        }else if(m_List.get(position).type == 1){
            //text.setBackgroundResource(R.drawable.message_out);
