 ...
 */
public class BoardContentFragment1 extends Fragment {
    ...
    public void getListData(String sListName, final String sLastNo) {
        ...
        aq.ajax("http://kgs.yunstone.com/ajax/board.php?lat=" +lat+"&lon="+lon+"&start=0&uuid="+uuid+"&set=1", JSONObject.class, new AjaxCallback<JSONObject>() {
            @Override
