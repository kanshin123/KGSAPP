...
import static apps.com.kgs.BaseApplication.progressOFF;
import static apps.com.kgs.BaseApplication.progressON;
import static apps.com.kgs.R.layout.activity_splash;
...
public class SplashActivity extends AppCompatActivity {
    ...
    public void countDownTimer(int counttime) {
        ...
        GetDevicesUUID(getBaseContext()); //안드로이드 고유번호 가져오기
                /*///////////////////////// 첫실행인지 아닌지 체크///////////////
                SharedPreferences prefs = getSharedPreferences("isFirstRun", MODE_PRIVATE);
                boolean isFirstRun = prefs.getBoolean("isFirstRun", true);
                if (isFirstRun) {
