...
public class payment_wedding6 extends AppCompatActivity {
    private EditText payment_send_name;
    private EditText payment_send_money;
    private EditText payment_send_massage;
    private Button btn_payment_send;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.payment_wedding6);
        ...
        btn_payment_send = (Button) findViewById(R.id.btn_payment_send);

        //회원가입버튼 클릭시 체크
        btn_payment_send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (payment_send_name.getText().toString().length() == 0) {
                    Toast.makeText(payment_wedding6.this, "이름을 입력해 주세요.", Toast.LENGTH_SHORT).show();
                ...
                if (payment_send_money.getText().toString().length() == 0) {
                    Toast.makeText(payment_wedding6.this, "금액을 입력해 주세요.", Toast.LENGTH_SHORT).show();
...
////////////////완료시 서버에 파라미터 전달 끝////////////////////
    ...
    public void onBackPressed() {
        ...
        // super.onBackPressed();
        moveTaskToBack(true);
        Intent intent = new Intent(payment_wedding6.this,MainActivity.class);
